$(document).ready(function() {
    ...
    $('#email').click(function() {
            $(this).find('p').text('morteemain@gmail.com').css('font-size', '14px')
        })
        /* PRELOADER */
    ...
    function skillsSlider() {
        var skillsWidth = Number($('.about__slide_slide').width() + 100);
        console.log(skillsWidth)
        var skillsWrapper = $('.about__slide_wrapper');
